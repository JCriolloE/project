...
from release.api.models.models import Classifier
...
async def training(X, y):
    df = Loading.loadingData("C:\\Users\\jcriollo\\Desktop\\Respado\\ITESM\\" \
                             "Maestría Inteligencia Artificial\\Z - MLOPS\\" \
                             "Proyecto\\4. Despliegue de modelos de ML\\" \
